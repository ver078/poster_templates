...
output: 
  posterdown::posterdown_html:
    self_contained: FALSE # Change this to TRUE if you need your poster portable as a single html file
...
[GitHub repo](https://github.com/brentthorne/posterdown), or to dive straight in, use
...
knitr::kable(head(gapminder, n = 4), format = "html") %>% 
